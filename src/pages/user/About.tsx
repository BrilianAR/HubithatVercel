const AboutUs = () => {
  return (
    <div className="bg-gradient-to-b from-white to-white py-12 pt-30 max-w-7xl m-auto px-6 sm:px-6 lg:px-8">
      {/* Hero Section */}
      <div className="max-w-7xl mx-auto lg:text-center mb-16">
